...
What i want to specifically point out is the no use of back-end frameworks or any kind of dependencies because this is my version of the to-do app, which i wanted to test out
